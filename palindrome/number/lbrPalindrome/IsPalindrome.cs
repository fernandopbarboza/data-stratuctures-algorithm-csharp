...
- Solução/Código
*/
namespace lbrPalindrome;
public class PalindromeNumber {
    public bool IsPalindrome(int x) {
        // Casos base: números negativos não são palíndromos.
        // Se o número termina em 0, a única forma de ser palíndromo é se for o próprio 0.
        if (x < 0 || (x % 10 == 0 && x != 0)) {
            return false;
        }
        ...
        // Quando o tamanho for ímpar (ex: 12321), o x será 12 e o revHalf será 123.
        // Dividimos revHalf por 10 para ignorar o número central (3).
